...
\begin{IEEEeqnarray}{c}
  ...
  \mathcal{N} \left(\left[\begin{matrix} \boldsymbol{\mu}_{f} \\
      \mu_{*}\end{matrix} \right],
  \left[ \begin{matrix} \mathbf{K}_{ff}+ \sigma_{n}^{2}\mathbf{I} & \mathbf{K}_{f*} \\ \mathbf{K}_{*f} & \mathbf{K}_{**}\end{matrix} \right]  \right),
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
  p\left( f_* \middle| \mathbf{X}, \mathbf{y}, \mathbf{x}_* \right) & = & \mathcal{N}\left( f_* \middle| \mu, \sigma^2 \right),\label{eq:predictive_distribution}
\end{IEEEeqnarray}
{\bl
where:
\begin{IEEEeqnarray}{rCl}
  \mu & = & \mu_* + \mathbf{K}_{*f} \mathbf{\Sigma}_\theta^{-1}(\mathbf{y} - \boldsymbol{\mu}_f), \IEEEeqnarraynumspace  \\*
  \sigma^2 & = & \mathbf{K}_{**} - \mathbf{K}_{*f} \mathbf{\Sigma}_\theta^{-1}\mathbf{K}_{f*}, \IEEEeqnarraynumspace \\*
  \mathbf{\Sigma}_\theta & = & \mathbf{K}_{ff}+ \sigma_n^2\mathbf{I},\label{eq:kernel_plus_i}
\end{IEEEeqnarray}
...
\begin{IEEEeqnarray}{rCl}
  ...
  & = & \int \mathcal{N}\left(\mathbf{y} \middle| f(\mathbf{X}), \sigma_{n}^{2} \mathbf{I} \right) \mathcal{N}\left( f(\mathbf{X}) \middle| \mathbf{0}, \mathbf{K}_{ff} \right) \dd f(\mathbf{X})   \IEEEnonumber \\*
  & = & \mathcal{N} ( \mathbf{y} | \mathbf{0}, \mathbf{\Sigma}_\theta ),
\end{IEEEeqnarray}
Therefore, the negative log marginal likelihood (NLML) is {\bl
\begin{IEEEeqnarray}{rCl}
  \IEEEyesnumber
  \mathcal{L}(\theta) & = & - \text{log} p(\mathbf{y} | \mathbf{X}, \theta) \IEEEnonumber \\
  & = & \frac{1}{2}\mathbf{y}^T \mathbf{\Sigma}_\theta^{-1}\mathbf{y} + \frac{1}{2}\text{log}(\text{det}(\mathbf{\Sigma}_\theta)) + \frac{n}{2}\text{log}2\pi,
  \label{eq:nlml}
\end{IEEEeqnarray}
...
\begin{figure}[!tb]
  \centering
  \includegraphics[width=3in]{./images/axial_transformation_unit.eps}
...
where
\begin{IEEEeqnarray}{rCl}
 g(s_k;\boldsymbol{\alpha}) &=& \mathbf{w}_{a}^{(k)T} \cdot \boldsymbol{\phi}(s_k;\boldsymbol{\alpha}),\\* 
...
\begin{figure}[!tb]
  \centering
  \includegraphics[width=3in]{./images/rbf_unit.eps}
...
\begin{figure}[!tb]
  \centering
  \includegraphics[width=3in]{./images/mobius_unit.eps}
...
\begin{figure}[!tb]
  \centering
  \includegraphics[width=3in]{./images/TKGPR_model.eps}
...
% \begin{figure*}[!tb]
%   \centering
%   \includegraphics[width=7.16in]{./images/radio_map_letter.eps}
...
\begin{figure}[!tb]
  \centering
  \includegraphics[width=3in]{./images/rmse_comparison.eps}
...
\begin{figure}[!tb]
  \centering
  \includegraphics[width=3in]{./images/crps_comparison.eps}
...
%   in 2005 and 2010, respectively. He is currently pursuing a Ph.D. degree with
